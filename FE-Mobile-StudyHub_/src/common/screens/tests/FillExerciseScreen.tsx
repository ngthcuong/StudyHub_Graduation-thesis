...
export default function FillExerciseScreen() {
      ...
      <View style={styles.card}>
        ...
        <View style={styles.container}>
          ...
          <Text style={styles.question}>
            She <Text style={styles.blank}>______</Text> to Paris three times
            this year.
          </Text>
          ...
          <View style={styles.hintContainer}>
            <Text style={styles.hintText}>
              Hint:{"\n"}Think about the present perfect tense structure. The
              subject is 'She' (third person singular).
            </Text>
          </View>
        </View>
        ...
        <View style={styles.progressBarWrapper}>
          ...
          <View style={styles.progressLabels}>
            ...
            >
              ...
              />
              {/* Label */}
              <Text style={{ fontSize: 12, color: "#111827" }}>Completed</Text>
            </View>
