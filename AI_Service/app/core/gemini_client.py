...
def _build_prompt(payload: Dict[str, Any], local_results: Dict[str, Any]) -> str:
    ...
    prompt = (
        ...
        "3. Create a 'personalized_plan'. \n"
        "   - INSTRUCTION for 'materials':\n"
        "     a. Identify 2-3 specific, high-quality YouTube videos related to the topic.\n"
        "     b. For 'title': Provide the exact or likely title of the video (e.g., 'Master Future Tenses - BBC Learning English').\n"
        "     c. For 'url': Provide the direct YouTube link if you know it reliably. \n"
        "        **IMPORTANT**: If you are not 100% sure the direct link is valid/alive, generate a specific Search URL for that title (e.g., 'https://www.youtube.com/results?search_query=Master+Future+Tenses+BBC').\n"
